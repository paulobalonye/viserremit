...
class ManageUsersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'per_send_money_limit'     => 'nullable|numeric|gt:0',
            'daily_send_money_limit'   => 'nullable|numeric|gte:per_send_money_limit',
            'monthly_send_money_limit' => 'nullable|numeric|gte:monthly_send_money_limit',
        ]);
    ...
    public function showNotificationAllForm()
    {
        ...
        $notifyToUser = User::notifyToUser('user');
