...
@section('panel')
                    ...
                    @if ($agent->kv == 2)
                        <div class="d-flex flex-wrap justify-content-end mt-3">
                            ...
                            <button class="btn btn-outline--success confirmationBtn" data-question="@lang('Are you sure to approve this documents?')"
                                data-action="{{ route('admin.agents.kyc.approve', $agent->id) }}">
    ...
    <div id="kycRejectionModal" class="modal fade">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.agents.kyc.reject', $agent->id) }}" method="POST">
                    @csrf
