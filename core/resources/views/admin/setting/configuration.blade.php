                        ...
                        <ul class="list-group">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable')
                                            ...
                                            @lang('module, users must have to submit the required data. Otherwise, configured')
                                            <a href="{{ route('admin.kyc.setting.module') }}" target="_blank">@lang('modules')</a>
                                            @lang('will be prevented by this system. You\'ve to configure the')
                                            <span class="fw-bold"><i>@lang('KYC Setting')</i></span>.
                                        </small>
                                    </p>
                                </div>
                                <div class="form-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>
                                            @lang('If you enable')
                                            <span class="fw-bold">@lang('Email Verification')</span>,
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, user\'s can refer others.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="agent_module" @if (gs('agent_module')) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
