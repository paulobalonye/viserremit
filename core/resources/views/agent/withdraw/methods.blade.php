        ...
        <div class="col-lg-8">
            <div class="border--card">
                <div class="d-flex justify-content-between">
                    ...
                    <span class="fw-bold">@lang('Available Balance'): {{ showAmount(authAgent()->balance) }}</span>
                </div>
                <div class="card-body p-0">
                    <form action="{{ route('agent.withdraw.money') }}" method="post" class="withdraw-form disableSubmission">
                        @csrf
