    ...
    <div class="section section--xl">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <form action="{{ route('user.deposit.insert') }}" method="post" class="disableSubmission">
                        @csrf
                        <input name="currency" type="hidden">
                        <input name="amount" type="hidden" class="amount"
                            value="{{ $sendMoney->base_currency_amount + $sendMoney->base_currency_charge }}">
                                            ...
                                            <div class="payment-system-list is-scrollable gateway-option-list">
                                                ...
                                                @if ($gatewayCurrency->count() > 4)
                                                    <button type="button" class="payment-item__btn more-gateway-option">
                                                        <p class="payment-item__btn-text m-0">@lang('Show All Payment Options')</p>
                                            ...
                                            <div class="payment-system-list p-3">
                                                <div class="deposit-info">
                                                    ...
                                                    <div class="deposit-info__input">
                                                        <p class="text mb-0">
                                                            {{ showAmount($sendMoney->sending_amount + $sendMoney->sending_charge, currencyFormat: false) }}
                                                            {{ $sendMoney->sending_currency }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="deposit-info">
                                                    <div class="deposit-info__title">
                                                        <p class="text mb-0">@lang('In') {{ __(gs('cur_text')) }}</p>
                                                    </div>
                                                    <div class="deposit-info__input">
                                                        <p class="text mb-0">
                                                            {{ showAmount($sendMoney->base_currency_amount + $sendMoney->base_currency_charge) }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="info-text pt-3">
                                                    <p class="text m-0">@lang('Ensuring your funds grow safely through our secure deposit process with world-class payment options.')</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
